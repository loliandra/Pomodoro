...
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)  # on mac maybe use it
...
label_checkmark = Label(text="", fg=GREEN, font=(FONT_NAME, 12, "bold"), bg=YELLOW)
